...
export default class EC2VSCodeEnvironmentLifecycleService implements EnvironmentLifecycleService {
  ...
  public async terminate(envId: string): Promise<{ [id: string]: string }> {
    ...
    const ssmParamName = `/vscode/access-token/sc-environments/ec2-instance/${instanceId}`;
