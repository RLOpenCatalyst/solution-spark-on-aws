...
export default class EC2StataEnvironmentLifecycleService implements EnvironmentLifecycleService {
  ...
  public async terminate(envId: string): Promise<{ [id: string]: string }> {
    ...
    const ssmParamName = `/stata/access-token/sc-environments/ec2-instance/${instanceId}`;
